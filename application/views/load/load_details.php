...
//                                            $date_formated = $date_formated_temp[1] . '/' . $date_formated_temp[0] . '/' . $date_formated_temp[2];
                                            ...
                                            . '<td style="text-align: center;"><a href="../../../tkgo_files2/' . $row['url_bol'] . '" target="_blank">BOL</a> <a href="../../../tkgo_files2/' . $load['idts_load'] . '_bol_' . $row['bol_number'] . '_sp.pdf" target="_blank">POD</a> <a href="../../../tkgo_files2/' . $load['idts_load'] . '_bol_' . $row['bol_number'] . '_cs.pdf" target="_blank">SHP</a> </td>'
                                            . '</tr>';
